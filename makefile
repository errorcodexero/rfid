...
.PHONY: clean
clean:
	TFrm logger; rm log_reader.exe; rm autologger.exe; rm rankings.exe; rm check_order.exe; rm on_track.exe; rm reformat_log.exe; rm check_and_fix.exe; rm "log_shop_times.exe"
